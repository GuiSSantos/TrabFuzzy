...
fuzzycontrolD.insert_rule("M","M","M","MT");
...
fuzzycontrolD.insert_rule("P","L","ML","DT");
fuzzycontrolD.insert_rule("P","L","L","DT");
...
fuzzycontrolD.insert_rule("P","M","L","DT");
fuzzycontrolD.insert_rule("P","M","M","DT");
fuzzycontrolD.insert_rule("P","M","P","MF");
fuzzycontrolD.insert_rule("P","M","MP","MF");
fuzzycontrolD.insert_rule("P","P","ML","DF");
fuzzycontrolD.insert_rule("P","P","L","DT");
fuzzycontrolD.insert_rule("P","P","M","DF");
fuzzycontrolD.insert_rule("P","P","P","MT");
fuzzycontrolD.insert_rule("P","P","MP","MT");
fuzzycontrolD.insert_rule("P","MP","ML","DT");
fuzzycontrolD.insert_rule("P","MP","L","DT");
fuzzycontrolD.insert_rule("P","MP","M","DT");
fuzzycontrolD.insert_rule("P","MP","P","MT");
fuzzycontrolD.insert_rule("P","MP","MP","MT");
...
fuzzycontrolD.insert_rule("MP","ML","MP","RF");
fuzzycontrolD.insert_rule("MP","L","ML","RT");
fuzzycontrolD.insert_rule("MP","L","L","RT");
fuzzycontrolD.insert_rule("MP","L","M","MT");
fuzzycontrolD.insert_rule("MP","L","P","DT");
...
fuzzycontrolD.insert_rule("MP","M","MP","MT");
fuzzycontrolD.insert_rule("MP","P","ML","DF");
fuzzycontrolD.insert_rule("MP","P","L","DF");
fuzzycontrolD.insert_rule("MP","P","M","DF");
fuzzycontrolD.insert_rule("MP","P","P","MT");
fuzzycontrolD.insert_rule("MP","P","MP","MT");
fuzzycontrolD.insert_rule("MP","MP","ML","RT");
fuzzycontrolD.insert_rule("MP","MP","L","RT");
fuzzycontrolD.insert_rule("MP","MP","M","RT");
fuzzycontrolD.insert_rule("MP","MP","P","RT");
